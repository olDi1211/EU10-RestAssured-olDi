...
public class SpartanTestWithParameters {
  ...
  /*   Given accept type is Json
    ...
    @DisplayName("GET request to /api/spartans/{id} with ID5")
    @Test
    public void test1() {
        ...
        assertTrue(response.body().asString().contains("Blythee"));
    ...
    public void test2() {
        ...
        //verify "Not Found" message should be in response payload/body
